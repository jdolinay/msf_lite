...
/* Define the F_CPU value based on the CLOCK_SETUP selected by the user */
/*********************************************
*    Define the CPU frequency in Hertz 
********************************************/
 ...
 * Do not change the F_CPU directly here! It will not be actually change the
 * CPU settings!
*/
#if (CLOCK_SETUP == 0)
