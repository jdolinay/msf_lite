...
#define     MSF_ADC_RES_16_BITS      (4UL << MSF_ADC_RES_Pos)  /**< default resolution 16-bits */
#define     MSF_ADC_RES_12_BITS      (2UL << MSF_ADC_RES_Pos)  /**< default resolution 12-bits */
#define     MSF_ADC_RES_10_BITS      (3UL << MSF_ADC_RES_Pos)  /**< default resolution 10-bits */
